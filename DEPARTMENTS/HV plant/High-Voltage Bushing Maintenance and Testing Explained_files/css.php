...
.bbcode_container div.bbcode_quote {
	...
	font: normal  normal 0.9em Tahoma,Calibri,Verdana,Geneva,sans-serif;
	position: relative;
	top: 0;
}
...
.texteditor.forum textarea {
	color: #222222;
	font:    1.1em Verdana,Arial,Tahoma,Calibri,Geneva,sans serif;
	white-space:pre-wrap;
	background: #FFFFFF none   ;
}
...
.popupbody {
	font:   normal 1em Tahoma, Calibri, Verdana, Geneva, sans-serif;
	color: #3E3E3E;
	padding:3px;
...
.popupbody li label {
	...
	color: #3E3E3E;
	background:#FFFFFF none   ;
	padding:/* ~~cannot perform math on mixed units ~~ found (px,em,in) in /* ~~cannot perform math on mixed units ~~ found (px,em) in 26px-1.23em *//2 */ 10px;
	text-decoration:none;
	text-align:left;
	white-space:nowrap;
}
...
.popupbody li.formsubmit input[type="button"] {
	font:.8em Tahoma, Calibri, Verdana, Geneva, sans-serif;
	padding:2px;
	padding-bottom:1px;
}
...
.memberaction_body.popupbody {
	...
	-webkit-border-radius: 0px;
	border-radius: 0px;
	-moz-box-shadow: 0px 4px 7px #fff;
	-webkit-box-shadow: 0px 4px 7px #fff;
	box-shadow: 0px 4px 7px #fff;
}
...
.body_wrapper {
	padding: 1% 2% 1% 2%;
	background: #fcfcfc none repeat-x  ;
	-moz-border-radius: 0px;
	-webkit-border-radius: 0px;
	border-radius: 0px;
}
...
body,
legend {
	font-family:sans-serif, Arial, Verdana, Geneva, Tahoma;
}
...
.pagination span a {
	font:  normal 16px 'Oswald',sans-serif, Tahoma, Calibri, Verdana, Geneva;
	border: 0px solid #cedfeb;
	height: /* ~~cannot perform math on mixed units ~~ found (px,em) in 16px*1.230em */;
	padding: 2px 4px;
	margin-left: 1px;
...
.navpopupmenu {
	...
	display:block;
	padding: 0;
	padding-top: /* ~~cannot perform math on mixed units ~~ found (px,em,in) in /* ~~cannot perform math on mixed units ~~ found (px,em) in 16px+5px-.8em *//2 */;
	clear: left;
	margin-left: 10px;
	font-size: .8em;
	margin-top: 0;
...
#forumrules {
	...
	border-left: 0px none #c4c4c4;
	border-right: 0px none #c4c4c4;
	border-top: 1px solid #fff;
	background: #fff url(images/gradients/gradient-greytowhiteX.png) repeat-x  ;
}
...
.toplinks ul.isuser .notifications .popupbody {
	background: #006699;
	border: 1px solid #006699; /* makes it look consistent with the popup background */
}
...
.toplinks ul.isuser .notifications .popupbody li a{
	...
	padding: 0 5px;
	font-weight: normal;
	border-top:1px solid #006699; /* makes it look consistent with the popup background */
	text-align: left;
	padding-left: 30px;
	line-height: 26px;
}
...
.navbar {
	...
	color:#fff;
	font:  normal 0.8em Arial, Calibri, Verdana, Geneva, sans-serif;
...
.navtabs li a.navtab {
	...
	text-align:center;
	color: #ffffff;
	font:  bold 13px 'Open Sans',sans-serif,Arial, Calibri, Verdana, Geneva;
	text-decoration:none;
	line-height:28px;
	padding: 0 10px;
}
...
.navtabs li a.navtab:hover {
	background:#444444 url(images/gradients/selected-tab-gradient-with-top-alphaX.png) repeat-x   0 -2px;
	color:#efefef;
}
...
.navtabs li.selected a.navtab {
	color:#efefef;
	background:#444444 url(images/gradients/selected-tab-gradient-with-top-alphaX.png) repeat-x  ;
	position:relative;
	top:-2px;
	padding-top:2px;
	z-index:10;
...
.toplinks .notifications a.popupctrl {	
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #444444 url(images/misc/arrow.png) right center no-repeat ;
	-moz-border-radius-bottomleft: 0px;
	-moz-border-radius-bottomright: 0px;
	-webkit-border-bottom-right-radius:0px;
	-webkit-border-bottom-left-radius: 0px;
...
.toplinks .notifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl.active , .toplinks .notifications a.popupctrl.active{
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #444444 url(images/misc/arrow.png) no-repeat right center;
}
...
#pagetitle a { color:#151515; }
#pagetitle a:hover { color:; }

#pagetitle h1 {
	color: inherit;
	font:normal normal normal 28px 'Oswald',Tahoma, Calibri, Verdana, Geneva, sans-serif;
}
...
.newcontent_textcontrol {
	background: #006699 url(images/buttons/newbtn_middle.png) repeat-x left top;
	_background-image: none;
...
.newcontent_textcontrol:hover {
	background: #0099ff url(images/buttons/newbtn_middle.png) repeat-x left top;
	color: rgb(255, 255, 255);
	text-decoration: none;
}
